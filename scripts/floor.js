...
var Floor = (function () {
    ...
    function (gd, md) {
        ...
        f.render = function floorRenderFn(gd, camera) {
            ...
            // near left to right
            intersect(frustumPoints[0], frustumPoints[1]);
            intersect(frustumPoints[2], frustumPoints[3]);

            // far left to right
            intersect(frustumPoints[4], frustumPoints[5]);
            intersect(frustumPoints[6], frustumPoints[7]);
